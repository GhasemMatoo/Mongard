...
django_env.read_env(str(BASE_DIR / ".django"))

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-!s83c#5iszvi&p5@n1^u5^pcs%qu3-e0d0o8evy^qufzfk%^zw'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'orders.custom_context_processors.card',
            ],
        },
    },
]
...
# redis config in RedisCache
CACHES = {
    "default": {
        "BACKEND": "django.core.cache.backends.redis.RedisCache",
        "LOCATION": django_env('CACHES_LOCATION'),
    }
}

# Session reads use the cache
